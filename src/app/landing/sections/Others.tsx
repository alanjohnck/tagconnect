...
function Others() {
  ...
  return (
    <section ref={container} className='w-screen h-screen flex flex-col items-center justify-center'>
            ...
            <div className='w-[90%] h-3/4 flex flex-col md:flex-row items-center justify-center gap-4'>
                  <div className='w-screen md:w-[30%] h-full flex flex-col items-center justify-center'>
                        ...
                        <div className='w-full h-1/4 flex flex-col items-center justify-center gap-5 '>
                            ...
                            <p className='text-black font-[400] text-[12px] leading-[16px] lg:text-[16px] lg:leading-[19px] text-center'>
                              Real-Time Remote Support: Monitoring and Fixing Problems from Afar
                            </p>
                        </div>
                  </div>
                  <div className='w-[30%] h-full bg-[#EEF3ED]'>
